...
- 问题修复（M10.1）：typecheck 基线 5 条清零且检查范围扩至全量（GameEvents 改 type 别名、settings key 显式联合）；模拟器升级募兵机器人并重校虎狼难度（补贴 70→100、进取 1.6→1.9），800 局曲线 easy 70.3 / normal 40.0 / hard 21.8
- 后续：发行窗口与物料投放
