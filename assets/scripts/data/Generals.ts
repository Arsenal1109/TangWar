...
export const GENERALS: GeneralDef[] = [
    ...
    { id: 'xushiji', name: '徐世勣', title: '瓦岗 · 大将', faction: 'wa', loyalty: 82, stats: { command: 88, politics: 70, strategy: 85, valor: 75, prestige: 78 } },
    { id: 'shanxiongxin', name: '单雄信', title: '瓦岗 · 飞将', faction: 'wa', loyalty: 80, stats: { command: 80, politics: 20, strategy: 45, valor: 93, prestige: 72 } },
    { id: 'wangshichong', name: '王世充', title: '郑王 · 僭号洛阳', faction: 'zheng', loyalty: 90, stats: { command: 82, politics: 78, strategy: 85, valor: 70, prestige: 75 } },
